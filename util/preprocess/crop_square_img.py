...
def crop_square_img(file_list, new_root_folder):
...
if __name__ == '__main__':
  ...
  new_img_root = 'G:\\CSC-486-Stuff-and-Things\\linux_square_imgs'
  #img_root = new_img_root
  ...
  for phase in ['val']:
    for camera in ['1','2','3','4']:
      file_list = 'G:\\CSC-486-Stuff-and-Things\\img_list\\linux_accv_%s_camera_%sbbox.txt'%(phase,camera)
      crop_square_img(file_list, new_img_root)
